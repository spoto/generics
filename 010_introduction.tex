...
smart contracts, since they allow one to personalize the behaviour of such contracts and partially overcome the their inherent incompleteness\,\cite{ebp}. In Java source code, generics are strongly typed, if no \emph{unchecked operations}
