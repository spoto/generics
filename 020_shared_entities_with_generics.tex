...
Therefore, we have parameterized the interface of a shared entity with two type variables\<S> is the type of the shareholders and \<O> is the type of the offers for selling shares.
...
contracts can call these methods. This annotation explicitly states that the methods will
...
in \<S.class>. Due of this limitation,
...
and executed in blockchain is the Java bytecode which has been derived from
