...
\documentclass[default,iicol]{sn-jnl}% Default
...
\newcommand{\ltiny}{\fontsize{7}{9}\selectfont}
...
\lstset{
        ...
        extendedchars=true,
        basicstyle=\ltiny\ttfamily,%\scriptsize\ttfamily
        showstringspaces=false,
        showspaces=false,
        numbers=none,
        numberstyle=\ltiny,%\scriptsize,
        numbersep=9pt,
        tabsize=2,
        breaklines=true,
        showtabs=false,
...
\author{\fnm{Fausto} \sur{Spoto}}\email{fausto.spoto@univr.it}
\equalcont{These authors contributed equally to this work.}

\author*{\fnm{Sara} \sur{Migliorini}}\email{sara.migliorini@univr.it}
\equalcont{These authors contributed equally to this work.}

\author{\fnm{Mauro} \sur{Gambini}}\email{mauro.gambini@univr.it}
\equalcont{These authors contributed equally to this work.}

\author{\fnm{Andrea} \sur{Benini}}\email{andrea.benini@studenti.univr.it}
\equalcont{These authors contributed equally to this work.}

\affil{\orgdiv{Department of Computer Science}, 
\orgname{University of Verona}, \country{Italy}}
