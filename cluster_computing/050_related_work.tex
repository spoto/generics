...
do not have generic types. General-purpose programming languages do have
...
It is possible instead to insert this paper in the broader context of software correctness and security.
Namely, it has been estimated that, on average, software developers make from 100 to 150 errors
